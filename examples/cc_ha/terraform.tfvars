...
## 12. SSH management access from the local VPC is enabled by default (true). Uncomment if you
##     want to disable this.
##     Note: Cloud Connector will only be accessible via AWS Session Manager SSM

#mgmt_ssh_enabled                           = false

## 13. By default, a security group is created and assigned to the CC service interface(s).
...
## 17. By default, terraform will configure Cloud Connector with EBS encryption enabled.
##     Uncomment if you want to disable ebs encryption.

#ebs_encryption_enabled                     = false

## 18. By default, EBS encryptions is set to null which uses the AWS default managed/master key.
...
## 19. By default, Terraform will create an IAM policy for Cloud Connector instance(s) per
...
## 20. By default, if Terraform is creating SGs an outbound rule is configured enabling
...
## 21. By default, ZPA dependent resources are not created. Uncomment if you want to enable ZPA configuration in your VPC
...
## 22. Provide the domain names you want Route53 to redirect to Cloud Connector for ZPA interception. Only applicable for base + zpa or zpa_enabled = true
...
## 26. Provide your existing Cloud Connector private subnet IDs. Only uncomment and modify if you set byo_subnets to true.
...
## 30. Provide your existing NAT Gateway IDs. Only uncomment and modify if you set byo_cc_subnet to true
...
## 31. By default, this script will create new IAM roles, policy, and Instance Profiles for the Cloud Connector
...
## 33. By default, this script will create new Security Groups for the Cloud Connector mgmt and service interfaces
...
## 35. By default, this script will create new route table resources associated to Cloud Connector defined private subnets
...
## 36. Provide your existing private subnet IDs to create Route53 Outbound Endpoints in.
...
## 37. By default, this script will create new route table resources associated to Route53 defined private subnets
##     Uncomment, if you do NOT want to create new route tables (true or false. Default: true)
...
## 38. Provide your existing Workload Route Table IDs. Route Table IDs must be added as a list and should be paired to
