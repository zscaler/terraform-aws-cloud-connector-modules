...
## 17. Provide the domain names you want Route53 to redirect to Cloud Connector for ZPA interception. Only applicable for base + zpa or zpa_enabled = true
...
## 21. Provide your existing Cloud Connector private subnet IDs. Only uncomment and modify if you set byo_subnets to true.
...
## 25. Provide your existing NAT Gateway IDs. Only uncomment and modify if you set byo_cc_subnet to true
...
## 26. By default, this script will create new IAM roles, policy, and Instance Profiles for the Cloud Connector
...
## 28. By default, this script will create new Security Groups for the Cloud Connector mgmt and service interfaces
...
## 30. Provide your existing Workload Route Table IDs. Route Table IDs must be added as a list and should be paired to
