...
## 22. By default, ZPA dependent resources are not created. Uncomment if you want to enable ZPA configuration in your VPC
...
## 23. Provide the domain names you want Route53 to redirect to Cloud Connector for ZPA interception. Only applicable for base + zpa or zpa_enabled = true
...
## 27. Provide your existing Cloud Connector private subnet IDs. Only uncomment and modify if you set byo_subnets to true.
...
## 31. Provide your existing NAT Gateway IDs. Only uncomment and modify if you set byo_cc_subnet to true
...
## 32. By default, this script will create new IAM roles, policy, and Instance Profiles for the Cloud Connector
...
## 34. By default, this script will create new Security Groups for the Cloud Connector mgmt and service interfaces
