...
Additionally: Creates a second Cloud Connector in a new subnet/Availability Zone wwith Lambda confgiured for HA failover of workload route tables between the two Cloud Connectors
